...
public class RulesOfIncomingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            Cursor cursor = dataHelper.getDataROI();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.bt_forum_istorii_jizni:
                startActivity(new Intent(RulesOfIncomingActivity.this,IstoriesFromLifeActivity.class));
                break;
            case R.id.bt_forum_voprosy_otvety:
                startActivity(new Intent(RulesOfIncomingActivity.this,QuestionsAndAnswersActivity.class));
                break;
        }
    }
    public class ParseTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://213.159.215.186/api/v1/rules_of_incoming/?offset="+a+"&limit=15&format=json");
