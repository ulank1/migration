...
public class RVQuestionSecondAdapter extends RecyclerView.Adapter {
    ...
    public RVQuestionSecondAdapter(List<VseAndUzery> students, RecyclerView recyclerView,Context context) {
