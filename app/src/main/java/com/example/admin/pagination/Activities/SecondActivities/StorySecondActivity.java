...
public class StorySecondActivity extends AppCompatActivity {
    ...
    public void onClickQA(View view) {
        ...
        try {
            ...
            obj.put("question","/api/v1/story/"+id+"/");
    ...
    public class ParseTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                URL url = new URL("http://176.126.167.231:8000/api/v1/story_comment/?question__id="+id+"&offset="+a+"&limit=15&format=json");
    ...
    class SendJsonDataToServer extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            BufferedReader reader = null;
            try {
                URL url = new URL("http://176.126.167.231:8000/api/v1/story_comment/");
                urlConnection = (HttpURLConnection) url.openConnection();
