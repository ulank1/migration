    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       progressBar.setVisibility(View.GONE);
        ...
        if (connectivityManager.getNetworkInfo(ConnectivityManager.TYPE_MOBILE).getState() == NetworkInfo.State.CONNECTED ||
            ...
            Cursor cursor = dataHelper.getDataForum();
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.bt_forum_istorii_jizni:
                startActivity(new Intent(ForumActivity.this,IstoriesFromLifeActivity.class));
                Log.e("SUKA","SUKA");
                break;
            case R.id.bt_forum_voprosy_otvety:
                startActivity(new Intent(ForumActivity.this,QuestionsAndAnswersActivity.class));
                break;
        }
    }
